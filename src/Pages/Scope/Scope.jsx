    ...
    <div className="scope-wrapper">
      ...
      <div className="scope-content">
        <div className="scope-intro">
          <p>
            The International Conference on Sustainable, Intelligent Systems, Communication Hardware, and Quantum Technology (ISHQ) aims to address the rapidly evolving technological landscape driven by digital transformation, intelligent automation, and next-generation hardware innovations. The conference focuses on cutting-edge research integrating advanced chip design, intelligent systems, communication technologies, sustainable energy solutions, and scalable industrial applications, fostering strong collaboration between academia, research organizations, and industry. <br /><br />
            With the emergence of transformative technologies such as AI-enabled hardware, 5G/6G communication, edge intelligence, quantum computing, cyber-physical systems, and bio-inspired computing, ISHQ provides a multidisciplinary platform to discuss innovative solutions for modern challenges in healthcare, smart manufacturing, sustainable energy, intelligent transportation, agriculture, and smart infrastructure.
          </p>
        </div>

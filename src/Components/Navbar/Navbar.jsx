            ...
            <div className="conference-header-content">
              ...
              <div className="header-logo left-header-logo">
                <a href="https://cutm.ac.in/" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/cutm_logo.png" alt="CUTM Logo" className="header-logo-img" />
                </a>
              </div>
              ...
              <div className="header-logo right-header-logo">
                <img src="/assets/ieee_logo.png" alt="IEEE Logo" className="header-logo-img" />
              </div>
            </div>
          </div>
          ...
          <div className="mobile-top-bar">
            <div className="mobile-logos">
              <div className="mobile-logo-item">
                <a href="https://cutm.ac.in/" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/cutm_logo.png" alt="CUTM Logo" className="mobile-logo-img" />
                </a>
              </div>
        ...
        <div className="mobile-menu-header">
          <div className="mobile-menu-logo">
            <div className="menu-logo-item">
              <a href="https://cutm.ac.in/" target="_blank" rel="noopener noreferrer">
                <img src="/assets/cutm_logo.png" alt="CUTM" className="menu-logo-img" />
              </a>
            </div>
            <div className="menu-logo-item">
            ...
            <div className="menu-logo-item">
              <img src="/assets/ieee_logo.png" alt="IEEE" className="menu-logo-img" />
            </div>
          </div>
          <button 
